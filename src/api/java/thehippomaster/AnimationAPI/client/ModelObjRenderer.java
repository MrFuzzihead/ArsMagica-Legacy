 ...
 * A simple ModelRenderer-compatible class that allows the modder to link custom models to ModelRenderer models. Very
 * useful
 * if the modder wants to replace a previous ModelRenderer with a custom model piece without having to redo all of the
 * translations, scales, and rotations. However, this model renders the methods addBox, setTextureOffset, etc useless,
 * as it
