...
public class AMParticle extends EntityFX {
    ...
    public void SetParticleTextureByName(String name) {
        ...
        if (name.equals("radiant")) isRadiant = true;
    }
    ...
    public void onUpdate() {
        ...
        if (doVelocityUpdates) this.moveEntity(this.motionX, this.motionY, this.motionZ);
        ...
        if ((particleAge++ > particleMaxAge && !this.ignoreMaxAge)
            || (!ignoreNoControllers && controllers.size() == 0)) {
            setDead();
        }
    }
    ...
    @Override
    public void renderParticle(Tessellator tessellator, float partialframe, float cosyaw, float cospitch, float sinyaw,
        ...
        if (this.isRadiant) {
            ...
            tessellator.setColorRGBA_F(
                this.GetParticleRed(),
                this.GetParticleGreen(),
                this.GetParticleBlue(),
                this.GetParticleAlpha());
            ...
            tessellator.addVertexWithUV(
                f11 - cosyaw * scaleFactorX - sinsinpitch * scaleFactorX,
                f12 - cospitch * scaleFactorY,
                f13 - sinyaw * scaleFactorZ - cossinpitch * scaleFactorZ,
                max_u,
                max_v);
            tessellator.addVertexWithUV(
                f11 - cosyaw * scaleFactorX + sinsinpitch * scaleFactorX,
