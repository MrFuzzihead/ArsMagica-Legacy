            ...
            if (i < 4) {
                ...
                if (i >= 4 && i < 31) {
                    if (itemstack1.getItem() instanceof ItemFocus) {
                        if (!(itemstack1.getItem() instanceof ItemFocusCharge)
                            && !(itemstack1.getItem() instanceof ItemFocusMana)) {
                            if (!this.hasCastingFocus()) {
                                for (availableSlots = 0; availableSlots < 3; ++availableSlots) {
                                    ...
                                    if (!focusSlot.getHasStack()) {
                                        focusSlot.putStack(
                                            new ItemStack(itemstack1.getItem(), 1, itemstack1.getItemDamage()));
