...
public class ContainerSpellBook extends Container {
     ...
     * var8 = var7.getStack();
     * if (var8 != null && var8.itemID == par1ItemStack.itemID && (!par1ItemStack.getHasSubtypes() ||
     * par1ItemStack.getItemDamage() == var8.getItemDamage()) && ItemStack.areItemStacksEqual(par1ItemStack, var8))
     * {
