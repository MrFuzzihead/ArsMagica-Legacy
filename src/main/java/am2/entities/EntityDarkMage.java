...
public class EntityDarkMage extends EntityMob {
    ...
    public EntityDarkMage(World world) {
        ...
        ExtendedProperties.For(this)
            .setMagicLevelWithMana(10 + rand.nextInt(20));
        initAI();
    }
    ...
    private void initAI() {
        ...
        this.tasks.addTask(
            4,
            new EntityAIRangedAttackSpell(this, MovementSpeed(), 40, NPCSpells.instance.darkMage_DiminishedAttack));
        ...
        this.targetTasks.addTask(
            ...
            new EntityAINearestAttackableTarget(
                ...
                true,
                false,
                DarkMageEntitySelector.instance));
    ...
    private int getAverageNearbyPlayerMagicLevel() {
        ...
        List<EntityPlayer> players = worldObj.getEntitiesWithinAABB(
            EntityPlayer.class,
            AxisAlignedBB.getBoundingBox(this.posX - 250, 0, this.posZ - 250, this.posX + 250, 250, this.posZ + 250));
    ...
    public boolean getCanSpawnHere() {
        ...
        ExtendedProperties.For(this)
            .setMagicLevelWithMana(5);
        int avgLevel = getAverageNearbyPlayerMagicLevel();
        if (avgLevel == 0) {
            if (rand.nextInt(100) < 10) {
                this.tasks.addTask(
                    3,
                    new EntityAIRangedAttackSpell(this, MovementSpeed(), 80, NPCSpells.instance.darkMage_NormalAttack));
            ...
            if (levelRand > 60) {
                this.tasks.addTask(
                    ...
                    new EntityAIRangedAttackSpell(
                        ...
                        MovementSpeed(),
                        160,
                        NPCSpells.instance.darkMage_AugmentedAttack));
    ...
    public String getTexture() {
        return ResourceManager.getMobTexturePath(
            String.format("dark_mages/dark_mage_%d.png", this.dataWatcher.getWatchableObjectInt(DW_MAGE_SKIN)));
    }
