...
public class EntityHecate extends EntityZombie {
    ...
    public void onUpdate() {
        ...
        if (this.motionY < 0) this.motionY *= 0.79999f;
        ...
        if (this.worldObj != null) {
            ...
            if (this.worldObj.difficultySetting == EnumDifficulty.HARD && this.getAttackTarget() != null
    ...
    private void spawnInvisibilityParticles() {
        /*
         * for (int i = 0; i < 50; ++i){
         * ArsMagicaParticle effect = ParticleManager.spawn(this.worldObj, "hr_smoke", this.posX + rand.nextDouble(),
            ...
            if (effect != null) {
                if (this.currentForwardRotation < 0.24) {
                    ...
                    effect.AddParticleController(
                        new ParticleMoveOnHeading(effect, this.rotationYaw - 90, this.rotationPitch, 0.01f, 1, false));
                }
