...
public class EntityFishHookInfernal extends EntityFishHook {

    public static final List nether_fishing = Arrays.asList(
        new WeightedRandomFishable[] { new WeightedRandomFishable(new ItemStack(Items.nether_wart), 10),
            new WeightedRandomFishable(new ItemStack(Items.blaze_powder), 10),
        ...
        if (this.field_146055_aB > 0) {
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (this.field_146042_b.isDead || !this.field_146042_b.isEntityAlive()
                    || itemstack == null
                    || itemstack.getItem() != ItemsCommonProxy.itemInfernalFishingRod
            ...
            if (!this.field_146051_au) {
                ...
                for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) f5) * 180.0D
                    ...
                    if (this.field_146045_ax > 0) {
                        ...
                        if (this.field_146038_az > 0) {
                            ...
                            if (this.field_146038_az <= 0) {
                                ...
                                float f4 = f2 * 0.04F;
                                worldserver
                                    .func_147487_a("reddust", d11, d5, d6, 0, (double) f4, 0.01D, (double) (-f3), 1.0D);
                                worldserver
                                    .func_147487_a("reddust", d11, d5, d6, 0, (double) (-f4), 0.01D, (double) f3, 1.0D);
                            }
    ...
    private ItemStack getItemToGive() {
        if (field_146042_b.worldObj.provider.dimensionId == -1) { // nether lava
            return ((WeightedRandomFishable) WeightedRandom.getRandomItem(rand, nether_fishing)).func_150708_a(rand);
        } else { // any other lava
