...
public class CommonProxy {
    ...
    public void postinit() {
        ...
        FMLCommonHandler.instance()
            .bus()
            .register(new ArmorEventHandler());
    ...
    public void preinit() {
        ...
        ObeliskFuelHelper.instance
            .registerFuelType(new ItemStack(ItemsCommonProxy.itemOre, 0, ItemOre.META_VINTEUMDUST), 200);
        ObeliskFuelHelper.instance
            .registerFuelType(new ItemStack(ItemsCommonProxy.itemAMBucket, 0, Short.MAX_VALUE), 2000);
        ObeliskFuelHelper.instance.registerFuelType(new ItemStack(AMOres, 0, BlockAMOre.META_VINTEUM_BLOCK), 2700);

        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Blocks.stonebrick), new ItemStack(Blocks.stonebrick, 1, 2));
        ...
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.nether_wart), new ItemStack(ItemsCommonProxy.stormSawtoothSeeds));
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.wheat_seeds), new ItemStack(ItemsCommonProxy.rainRockroseSeeds));

        // broken records
        EnervatorRecipeHelper.instance.registerRecipe(new ItemStack(Items.record_13), new ItemStack(Items.record_11));
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.record_blocks), new ItemStack(Items.record_11));
        EnervatorRecipeHelper.instance.registerRecipe(new ItemStack(Items.record_cat), new ItemStack(Items.record_11));
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.record_chirp), new ItemStack(Items.record_11));
        ...
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.record_mellohi), new ItemStack(Items.record_11));
        EnervatorRecipeHelper.instance.registerRecipe(new ItemStack(Items.record_stal), new ItemStack(Items.record_11));
        EnervatorRecipeHelper.instance
            .registerRecipe(new ItemStack(Items.record_strad), new ItemStack(Items.record_11));
    ...
    public void init() {
        ...
        VillagerRegistry.instance()
            .registerVillagerId(AMCore.config.getVillagerProfessionID());
        VillagerRegistry.instance()
            .registerVillageTradeHandler(AMCore.config.getVillagerProfessionID(), new MageVillagerTrade());
    }
    ...
    public void setViewSettings() {
        if (ExtendedProperties.For(getLocalPlayer())
            .getFlipRotation() > 0) Minecraft.getMinecraft().gameSettings.thirdPersonView = 0;
    }
    ...
    public void decrementFlickerCount() {
        this.totalFlickerCount--;
        if (this.totalFlickerCount < 0) this.totalFlickerCount = 0;
    }
