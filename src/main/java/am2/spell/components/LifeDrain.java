...
public class LifeDrain implements ISpellComponent {
    ...
    public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
        ...
        int magnitude = SpellUtils.instance
            .getModifiedInt_Add(4, stack, caster, target, world, 0, SpellModifiers.DAMAGE);

        boolean success = SpellHelper.instance
            .attackTargetSpecial(stack, target, DamageSource.causeIndirectMagicDamage(caster, caster), magnitude);
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLACK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONE), BlocksCommonProxy.aum };
    }
