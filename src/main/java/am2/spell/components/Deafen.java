...
public class Deafen implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_BROWN),
            new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_WHITE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ANIMALFAT), new ItemStack(Items.record_11) };
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Items.blaze_powder), new ItemStack(Items.bone),
