...
public class LightningDamage implements ISpellComponent {
    ...
    public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
        ...
        return SpellHelper.instance
            .attackTargetSpecial(stack, target, DamageSources.causeEntityLightningDamage(caster), (float) damage);
    }
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_YELLOW),
