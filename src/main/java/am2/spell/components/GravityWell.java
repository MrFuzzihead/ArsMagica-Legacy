...
public class GravityWell implements ISpellComponent, IRitualInteraction {
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (particle != null) {
                ...
                particle.AddParticleController(
                    new ParticleLeaveParticleTrail(particle, "pulse", false, 5, 2, false)
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_GREEN), Items.string,
            Blocks.stone };
    }

    @Override
    public float getAffinityShift(Affinity affinity) {
        if (affinity == Affinity.EARTH) return 0.03f;
        else return 0.01f;
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Items.blaze_powder) };
    }
