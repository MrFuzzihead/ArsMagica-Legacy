...
public class Storm implements ISpellComponent {
        ...
        if (world.getWorldInfo()
            ...
            if (!world.isRemote) {
                ...
                if (random < 20) {
                    ...
                    if (target != null
                        && world.canBlockSeeTheSky((int) target.posX, (int) target.posY, (int) target.posZ)) {
            ...
            if (!world.isRemote && !world.getWorldInfo()
                ...
                int duration = SpellUtils.instance
                    .getModifiedInt_Mul(600, stack, caster, null, world, SpellModifiers.DURATION) * 20;
                world.getWorldInfo()
                    .setRainTime(duration);
                world.getWorldInfo()
                    .setThunderTime(duration);
                world.getWorldInfo()
                    .setRaining(true);
                world.getWorldInfo()
                    .setThundering(true);
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        if (particle != null) {
            particle
                .AddParticleController(new ParticleOrbitEntity(particle, target, 0.2f, 2, false).SetTargetDistance(1));
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemRune.META_YELLOW),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_BLUETOPAZ),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_RAINROCKROSE), Items.ghast_tear };
    }
