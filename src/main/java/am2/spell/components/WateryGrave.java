...
public class WateryGrave implements ISpellComponent, IRitualInteraction {
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (particle != null) {
                ...
                particle.AddParticleController(
                    new ParticleLeaveParticleTrail(particle, "water_ball", false, 5, 2, false)
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLUE), Blocks.stone,
            Items.leather_boots };
    }
