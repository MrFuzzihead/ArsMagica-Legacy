...
public class Wave implements ISpellShape {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_VINTEUMDUST),
            BlocksCommonProxy.magicWall, "E:*", 25000 };
    }
    ...
    public SpellCastResult beginStackStage(ItemSpellBase item, ItemStack stack, EntityLivingBase caster,
        ...
        int duration = SpellUtils.instance
            .getModifiedInt_Mul(20, stack, caster, target, world, 0, SpellModifiers.DURATION);
        double speed = SpellUtils.instance
            .getModifiedDouble_Add(1f, stack, caster, target, world, 0, SpellModifiers.SPEED) * 0.5f;
