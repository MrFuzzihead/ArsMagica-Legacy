...
public class Binding implements ISpellShape {
    ...
    public SpellCastResult beginStackStage(ItemSpellBase item, ItemStack stack, EntityLivingBase caster,
        ...
        if (heldStack == null || heldStack.getItem() != ItemsCommonProxy.spell
            || !(SpellUtils.instance.getShapeForStage(stack, 0) instanceof Binding)) {
            return SpellCastResult.EFFECT_FAILED;
        }
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_CHIMERITE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_COGNITIVEDUST), Items.wooden_sword,
