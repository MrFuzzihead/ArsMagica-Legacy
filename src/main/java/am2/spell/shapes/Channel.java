...
public class Channel implements ISpellShape {
    ...
    public SpellCastResult beginStackStage(ItemSpellBase item, ItemStack stack, EntityLivingBase caster,
        ...
        boolean shouldApplyEffect = useCount % 10 == 0
            || SpellUtils.instance.componentIsPresent(stack, Telekinesis.class, 0)
            || SpellUtils.instance.componentIsPresent(stack, Attract.class, 0)
            || SpellUtils.instance.componentIsPresent(stack, Repel.class, 0);
    ...
    public Object[] getRecipeItems() {
        ...
        return new Object[] { new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ARCANEASH),
            new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_ARCANE), BlocksCommonProxy.tarmaRoot, "E:*",
            500 };
    }
