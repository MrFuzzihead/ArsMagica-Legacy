...
public class Zone implements ISpellShape {
    ...
    public SpellCastResult beginStackStage(ItemSpellBase item, ItemStack stack, EntityLivingBase caster,
        ...
        double gravity = SpellUtils.instance
            .getModifiedDouble_Add(0, stack, caster, target, world, 0, SpellModifiers.GRAVITY);
        int duration = SpellUtils.instance
            .getModifiedInt_Mul(100, stack, caster, target, world, 0, SpellModifiers.DURATION);
        ...
        if (persistenceModifiers > 0) {
            int zoneLingerDuration = SpellUtils.instance
                .getModifiedInt_Mul(90, stack, caster, target, world, 0, SpellModifiers.DURATION);
            lingeringSpellList.add(
                new SpellHelper.LingeringSpell(
    ...
    public Object[] getRecipeItems() {
        return new Object[] { BlocksCommonProxy.tarmaRoot,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_MOONSTONE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SUNSTONE), Items.diamond };
    }
