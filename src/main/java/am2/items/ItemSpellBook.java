...
public class ItemSpellBook extends ArsMagicaItem {
    ...
    private final String[] npc_textureFiles = { "affinity_tome_general", "affinity_tome_ice", "affinity_tome_life",
        "affinity_tome_fire", "affinity_tome_lightning", "affinity_tome_ender" };
    ...
    public String getItemStackDisplayName(ItemStack par1ItemStack) {
        ...
        if (activeSpell != null) {
            return String.format(
                "\2477%s (" + activeSpell.getDisplayName() + "\2477)",
                StatCollector.translateToLocal("item.arsmagica2:spellBook.name"));
        }
    ...
    public ItemStack onItemRightClick(ItemStack bookstack, World world, EntityPlayer entityplayer) {
        if (entityplayer.isSneaking() && !world.isRemote) {
            FMLNetworkHandler.openGui(
                entityplayer,
                AMCore.instance,
                ArsMagicaGuiIdList.GUI_SPELL_BOOK,
                world,
