...
public class ItemEssence extends ArsMagicaItem {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        for (PowerTypes type : PowerTypes.all()) {
            if ((mask & type.ID()) == type.ID()) {
                ...
                else s += "\n" + StatCollector.translateToLocal("am2.gui.or")
                    + StatCollector.translateToLocal("item.arsmagica2:rawEssence.name")
                    + " ("
                    + type.name()
                    + ")";
            }
    ...
    public void registerIcons(IIconRegister iconRegister) {
        textures = new String[] { "essence_arcane", "essence_earth", "essence_air", "essence_fire", "essence_water",
            "essence_plant", "essence_ice", "essence_lightning", "essence_life", "essence_nightmare", "essence_ender",
            "pure_essence", "high_essence_core", "base_essence_core" };
