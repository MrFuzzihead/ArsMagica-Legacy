...
public class AMSpawnEgg extends ArsMagicaItem {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        MovingObjectPosition mop = ItemsCommonProxy.spell
            .getMovingObjectPosition(par3EntityPlayer, par2World, 8.0f, true, false);
        ...
        if (mop != null && mop.typeOfHit == MovingObjectType.ENTITY && !par2World.isRemote) {
            ...
            if (entity != null) {
                ...
                if (mop.entityHit instanceof EntityHecate
                    && getSpawnClassFromMeta(par1ItemStack.getItemDamage()) == EntityHecate.class) {
