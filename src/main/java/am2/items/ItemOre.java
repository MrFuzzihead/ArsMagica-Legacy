...
public class ItemOre extends ArsMagicaItem {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        textures = new String[] { "vinteum_dust", "arcane_compound", "arcane_ash", "purified_vinteum", "chimerite_gem",
            "blue_topaz_gem", "sunstone_gem", "moonstone_gem", "animalFat", "celestial_fish", "cosmic_dust",
            "moonstone_fragment", "sunstone_fragment", "hellfish", "pyrogenic_sediment", "spatial_star",
            "temporal_cluster", "stormSawtooth_stage_2", "rainRockrose_stage_2", "imbuedMoonflower_stage_2",
    ...
    public boolean hasEffect(ItemStack p_77636_1_) {
        return p_77636_1_.getItemDamage() == META_SPATIALSTAR || p_77636_1_.getItemDamage() == META_SOULFRAGMENT
            || p_77636_1_.getItemDamage() == META_FRACTALFRAGMENT;
    }
    ...
    public EnumRarity getRarity(ItemStack p_77613_1_) {
        return (p_77613_1_.getItemDamage() == META_SPATIALSTAR || p_77613_1_.getItemDamage() == META_TEMPORALCLUSTER
            || p_77613_1_.getItemDamage() == META_SOULFRAGMENT
            || p_77613_1_.getItemDamage() == META_FRACTALFRAGMENT) ? EnumRarity.epic : EnumRarity.common;
    }
