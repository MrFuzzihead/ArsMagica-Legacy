...
public class BytecodeTransformers implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] bytes) {
        ...
        if (transformedName.equals("net.minecraft.client.renderer.EntityRenderer")) {
            LogHelper.info(
                "Core: Altering definition of " + transformedName
                    + ", "
                    + (is_obfuscated ? " (obfuscated)" : "(not obfuscated)"));
            bytes = alterEntityRenderer(bytes, is_obfuscated);
        } else if (name.equals("net.minecraft.server.MinecraftServer")
            || transformedName.equals("net.minecraft.server.MinecraftServer")) {
                LogHelper.info(
                    "Core: Altering definition of " + transformedName
                        + ", "
                        + (is_obfuscated ? " (obfuscated)" : "(not obfuscated)"));
                 ...
                 * // (it's actually a stroke of good luck that this code was never updated to 1.7.10 and never
                 * activated in a dev environment)
                 * // (otherwise, I'd most likely not have been able to implement the fix for soulbound items in the
                 * End)
                 * }else if (transformedName.equals("net.minecraft.entity.EntityPlayerMP")){
                 * LogHelper.info("Core: Altering definition of " + transformedName + ", " + (is_obfuscated ?
                ...
                && !(CustomLoadingPlugin.foundDragonAPI || checkIsDragonApiFilePresent())) {
                ...
                } else if (transformedName.equals("net.minecraft.network.play.server.S1DPacketEntityEffect")
                    && !(CustomLoadingPlugin.foundDragonAPI || checkIsDragonApiFilePresent())) {
                        LogHelper.info(
                            "Core: Altering definition of " + transformedName
                                + ", "
                    ...
                    if (node instanceof LdcInsnNode) {
                        ...
                        if ((ldcNode.cst instanceof Long) && ((Long) ldcNode.cst == 50L)) {
                            list.add(
                                new FieldInsnNode(
                                    Opcodes.GETSTATIC,
                                    "net/tclproject/mysteriumlib/asm/fixes/MysteriumPatchesFixesMagicka",
                                    "servertickrate",
                                    "J"));
                            continue intrucLoop;
                        }
    ...
    private byte[] alterRendererLivingEntity(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: boh/a (Lsv;DDDFF)V net/minecraft/client/renderer/entity/RendererLivingEntity/func_76986_a
        // (Lnet/minecraft/entity/EntityLivingBase;DDDFF)V

        // RendererLivingEntity.renderLivingAt = boh.a
        // MCP mapping: boh/a (Lsv;DDD)V net/minecraft/client/renderer/entity/RendererLivingEntity/func_77039_a
        ...
        for (MethodNode mn : cn.methods) {
            if (mn.name.equals(method1_name.getVal(is_obfuscated))
                && mn.desc.equals(method1_desc.getVal(is_obfuscated))) {
                ...
                while (instructions.hasNext()) {
                    ...
                    if (node instanceof MethodInsnNode) {
                        ...
                        if (method.name.equals(method1_searchinstruction_function.getVal(is_obfuscated))
                            && method.desc.equals(method1_searchinstruction_desc.getVal(is_obfuscated))) { // renderLivingAt(EntityLivingBase,
                                                                                                           // double,
                                                                                                           // double,
                                                                                                           // double)
                            target = node;
                ...
                if (target != null) {
                    ...
                    MethodInsnNode callout = new MethodInsnNode(
                        Opcodes.INVOKESTATIC,
                        "am2/utility/RenderUtilities",
                        "setupShrinkRender",
                        method1_replaceinstruction_desc.getVal(is_obfuscated));
    ...
    private byte[] alterEntityRenderer(byte[] bytes, boolean is_obfuscated) {
        ...
        // we are also searching for gluPerspective, description (FFFF)V, but this is a GL function call and is not
        // obfuscated.
        ...
        // MCP mapping: MD: qi/a (Ljava/lang/String;)V net/minecraft/profiler/Profiler/func_76320_a
        // (Ljava/lang/String;)V
            ...
            if (mn.name.equals(method1_name.getVal(is_obfuscated)) && mn.desc.equals(method1_desc)) { // setupCameraTransform
                ...
                while (instructions.hasNext()) {
                    ...
                    if (node instanceof MethodInsnNode) {
                        ...
                        if (orientCameraNode == null
                            && method.name.equals(method1_searchinstruction_function.getVal(is_obfuscated))
                            && method.desc.equals(method1_searchinstruction_desc)) { // orientCamera
                ...
                while (instructions.hasNext()) {
                    ...
                    if (!mouseFound) {
                        ...
                        if (node instanceof MethodInsnNode) {
                            MethodInsnNode method = (MethodInsnNode) node;
                            if (method.owner.equals(method2_searchinstruction_class.getVal(is_obfuscated))
                                && method.name.equals(method2_searchinstruction_function.getVal(is_obfuscated))
                                && method.desc.equals(method2_searchinstruction_desc)) {
                                LogHelper.debug(
                                    "Core: Located target method insn node: " + method.owner
                                        + "."
                                        + method.name
                                        + ", "
                                        + method.desc);
                ...
                if (target != null) {
                    int iRegister = (MysteriumPatchesFixLoaderMagicka.isOptiFinePresent()
                        || checkIsOptifineFilePresent()) ? 3 : 2;
                    ...
                    MethodInsnNode callout = new MethodInsnNode(
                        ...
                        "am2/guis/AMGuiHelper",
                        "overrideMouseInput",
                        method2_insertinstruction_desc.getVal(is_obfuscated));
    ...
    private void checkForOpt(String path) {
        if ((path.contains("optifine") && path.endsWith(".jar")) || (path.contains("OptiFine") && path.endsWith(".jar"))
            || (path.contains("Optifine") && path.endsWith(".jar"))) {
            System.out.println(
                "Optifine detected! Attempting compatibility. If you do not have optifine, this is an error; report it.");
            isOptifineFilePresent = true;
        }
        if ((path.contains("DragonAPI") && path.endsWith(".jar"))
            || (path.contains("dragonapi") && path.endsWith(".jar"))
            || (path.contains("Dragonapi") && path.endsWith(".jar"))) {
            System.out.println(
                "DragonAPI detected! Attempting compatibility. If you do not have DragonAPI, this is an error; report it.");
            isDragonApiFilePresent = true;
        }
        if ((path.contains("Thaumcraft") && path.endsWith(".jar"))
            || (path.contains("thaumcraft") && path.endsWith(".jar"))
            || (path.contains("ThaumCraft") && path.endsWith(".jar"))) {
            System.out.println(
                "Thaumcraft detected! Attempting compatibility. If you do not have Thaumcraft, this is an error; report it.");
                        ...
                        if (node instanceof FieldInsnNode && ((FieldInsnNode) node).getOpcode() == Opcodes.GETFIELD) { // movementInput.
                            ...
                            if (node instanceof MethodInsnNode) {
                                ...
                                if (method.name.equals(method1_searchinstruction.getVal(is_obfuscated))
                                    ...
                                    LogHelper
                                        .debug("Core: Located target method insn node: " + method.name + method.desc);
                                    target = node;
                                    break;
                                }
                            }
    ...
    private byte[] alterWorld(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: ahb/a (Lsa;Ljava/lang/String;FF)V net/minecraft/world/World/func_72956_a
        ...
        for (MethodNode mn : cn.methods) {
            if (mn.name.equals(method1_name.getVal(is_obfuscated))
                ...
                while (instructions.hasNext()) {
                    AbstractInsnNode node = instructions.next();
                    if (node instanceof VarInsnNode && ((VarInsnNode) node).getOpcode() == Opcodes.ALOAD
                        && ((VarInsnNode) node).var == 5) {
                        AbstractInsnNode potentialMatch = node;
                        node = instructions.next();
                        if (node instanceof FieldInsnNode && ((FieldInsnNode) node).getOpcode() == Opcodes.GETFIELD
                            && ((FieldInsnNode) node).name.equals("name")
                            && ((FieldInsnNode) node).desc.equals("Ljava/lang/String;")
                            && ((FieldInsnNode) node).owner
                                .equals("net/minecraftforge/event/entity/PlaySoundAtEntityEvent")) {
                            LogHelper.debug(
                                "Core: Located target method insn node: " + ((FieldInsnNode) node).name
                                    + ", "
                ...
                if (target != null) {
                    ...
                    MethodInsnNode callout = new MethodInsnNode(
                        Opcodes.INVOKESTATIC,
                        "am2/utility/EntityUtilities",
                        "modifySoundPitch",
                        method1_replacement_desc.getVal(is_obfuscated));
    ...
    // this function is no longer necessary in 1.7.10, since our event handler seems to handle dimension transfers
    // properly
    // (in fact, it never actually triggered in 1.7.10 - the variable and function names were never updated)
    // the commented out code has been left here for future reference, in case the current event handler approach fails
    // in the future
    /*
     ...
     * FieldInsnNode fieldGet = new FieldInsnNode(Opcodes.GETFIELD, "am2/proxy/CommonProxy", "playerTracker",
     * "Lam2/PlayerTracker");
     * //ALOAD 0
     * VarInsnNode aLoad = new VarInsnNode(Opcodes.ALOAD, 0);
     * //INVOKEVIRTUAL am2/PlayerTracker.onPlayerDeath (Lnet/minecraft/entity/player/EntityPlayer;)V
     * MethodInsnNode callout = new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "am2/PlayerTracker", "onPlayerDeath",
     * "(Luf;)V");
    ...
    private byte[] alterNetHandlerPlayServer(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: nh/a (Ljd;)V net/minecraft/network/NetHandlerPlayServer/func_147347_a
        // (Lnet/minecraft/network/play/client/C03PacketPlayer;)V
        ...
        for (MethodNode mn : cn.methods) {
            if (mn.name.equals(method1_name.getVal(is_obfuscated))
                && mn.desc.equals(method1_desc.getVal(is_obfuscated))) { // processPlayer
                AbstractInsnNode target = null;
                LogHelper.debug("Core: Located target method " + mn.name + mn.desc);
                Iterator<AbstractInsnNode> instructions = mn.instructions.iterator();
                ...
                while (instructions.hasNext()) {
                    ...
                    if (node instanceof VarInsnNode && ((VarInsnNode) node).var == 1
                        && ((VarInsnNode) node).getOpcode() == Opcodes.ALOAD) { // ALOAD 1
                        node = instructions.next();
                        if (node instanceof MethodInsnNode && matchMethodNode(
                            (MethodInsnNode) node,
                            Opcodes.INVOKEVIRTUAL,
                            method1_searchinstruction_class.getVal(is_obfuscated),
                            method1_searchinstruction_function1.getVal(is_obfuscated),
                            method1_searchinstructions_desc)) {
                            node = instructions.next();
                            if (node instanceof VarInsnNode && ((VarInsnNode) node).var == 1
                                && ((VarInsnNode) node).getOpcode() == Opcodes.ALOAD) { // ALOAD 1
                                node = instructions.next();
                                if (node instanceof MethodInsnNode && matchMethodNode(
                                    ...
                                    Opcodes.INVOKEVIRTUAL,
                                    method1_searchinstruction_class.getVal(is_obfuscated),
                                    method1_searchinstruction_function2.getVal(is_obfuscated),
                                    method1_searchinstructions_desc)) {
                                    node = instructions.next();
                                    if (node instanceof InsnNode && ((InsnNode) node).getOpcode() == Opcodes.DSUB) { // DSUB
                                        node = instructions.next();
                                        if (node instanceof VarInsnNode && ((VarInsnNode) node).var == 13
                                            && ((VarInsnNode) node).getOpcode() == Opcodes.DSTORE) { // DSTORE 13
                                            target = node;
                                            break;
                                        }
                                    }
    ...
    private byte[] alterPotionEffect(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: rw/a (Ldh;)Ldh; net/minecraft/potion/PotionEffect/func_82719_a
        // (Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/nbt/NBTTagCompound

        // PotionEffect.readCustomPotionEffectFromNBT = rw.b
        // MCP mapping: rw/b (Ldh;)Lrw; net/minecraft/potion/PotionEffect/func_82722_b
        ...
        // LogHelper.debug("Core: looking for method " + method1_name.getVal(is_obfuscated) + " with signature " +
        // method1_desc.getVal(is_obfuscated));
        // LogHelper.debug("Core: looking for method " + method2_name.getVal(is_obfuscated) + " with signature " +
        // method2_desc.getVal(is_obfuscated));
        ...
        for (MethodNode mn : cn.methods) {
            ...
            if (mn.name.equals(method1_name.getVal(is_obfuscated))
                ...
                while (instructions.hasNext()) {
                    ...
                    if (node instanceof MethodInsnNode) {
                        MethodInsnNode method = (MethodInsnNode) node;
                        if (method.owner.equals(method1_searchinstruction_class.getVal(is_obfuscated))
                            && method.name.equals(method1_searchinstruction_function.getVal(is_obfuscated))
                            && method.desc.equals(method1_searchinstruction_desc.getVal(is_obfuscated))) { // setByte(string,
                                                                                                           // byte)
                            target = method;
                            // don't forget, you need to remove the i2b instruction which immediately precedes this one
                ...
                if (target != null) {
                    MethodInsnNode newset = new MethodInsnNode(
                        Opcodes.INVOKEVIRTUAL,
                        method1_searchinstruction_class.getVal(is_obfuscated),
                        method1_replaceinstruction_function.getVal(is_obfuscated),
                        method1_replaceinstruction_desc.getVal(is_obfuscated));
            ...
            } else if (mn.name.equals(method2_name.getVal(is_obfuscated))
                && mn.desc.equals(method2_desc.getVal(is_obfuscated))) {
                    ...
                    while (instructions.hasNext()) {
                        ...
                        if (node instanceof MethodInsnNode) {
                            ...
                            if (method.owner.equals(method2_searchinstruction_class.getVal(is_obfuscated))
                                && method.name.equals(method2_searchinstruction_function.getVal(is_obfuscated))
                                && method.desc.equals(method2_searchinstruction_desc.getVal(is_obfuscated))) { // getByte(string,
                                                                                                               // byte)
                                target = method;
                                break;
                            }
                    ...
                    if (target != null) {
                        MethodInsnNode newset = new MethodInsnNode(
                            Opcodes.INVOKEVIRTUAL,
                            method2_searchinstruction_class.getVal(is_obfuscated),
                            method2_replaceinstruction_function.getVal(is_obfuscated),
                            method2_replaceinstruction_desc.getVal(is_obfuscated));
    ...
    private byte[] alterS1DPacketEntityEffect(byte[] bytes, boolean is_obfuscated, String classname) {
        ...
        if (!is_obfuscated) {
            try {
                ...
                DataOutputStream dout = new DataOutputStream(
                    new FileOutputStream(new File(outDir, "SD1PacketEntityEffect_pre.class")));
        ...
        // MCP mapping: in/a (Let;)V net/minecraft/network/play/server/S1DPacketEntityEffect/func_148837_a
        ...
        // MCP mapping: in/b (Let;)V net/minecraft/network/play/server/S1DPacketEntityEffect/func_148840_b
        // (Lnet/minecraft/network/PacketBuffer;)V

        // PacketBuffer/writeByte() = et.writeByte()
        // MCP mapping: MD: et/writeByte (I)Lio/netty/buffer/ByteBuf; net/minecraft/network/PacketBuffer/writeByte
        // (I)Lio/netty/buffer/ByteBuf;

        // PacketBuffer.writeInt() = et.writeInt()
        // MCP mapping: MD: et/writeInt (I)Lio/netty/buffer/ByteBuf; net/minecraft/network/PacketBuffer/writeInt
        // (I)Lio/netty/buffer/ByteBuf;
        ...
        FieldNode potionID_intvar = new FieldNode(
            potionID_intvar_access,
            potionID_intvar_name,
            potionID_intvar_desc,
            null,
            null);
        ...
        for (MethodNode mn : cn.methods) {
            ...
            if (mn.name.equals(initmethod_name) && mn.desc.equals(initmethod_desc.getVal(is_obfuscated))) {
                ...
                while (instructions.hasNext()) {
                    ...
                    if (node instanceof MethodInsnNode) {
                        MethodInsnNode method = (MethodInsnNode) node;
                        if (method.owner.equals(initmethod_searchinstruction_owner.getVal(is_obfuscated))
                            && method.name.equals(initmethod_searchinstruction_function.getVal(is_obfuscated))
                            && method.desc.equals(initmethod_searchinstruction_desc)) { // getPotionID
                            node = instructions.next();
                                ...
                                if (node instanceof InsnNode && ((InsnNode) node).getOpcode() == Opcodes.IAND) {
                                    ...
                                    if (node instanceof InsnNode && ((InsnNode) node).getOpcode() == Opcodes.I2B) {
                                        ...
                                        if (node instanceof FieldInsnNode
                                            && ((FieldInsnNode) node).getOpcode() == Opcodes.PUTFIELD
                                            && ((FieldInsnNode) node).name
                                                .equals(potionid_bytevar_name.getVal(is_obfuscated))
                                            && ((FieldInsnNode) node).desc.equals(potionid_bytevar_origdesc)) {
                                            toReplace = node;
                                            break;
                                        }
                                    }
                ...
                if (toRemove1 != null && toRemove2 != null && toRemove3 != null && toReplace != null) {
                    InsnNode new_nop = new InsnNode(Opcodes.NOP);
                    FieldInsnNode new_potion_id_variable = new FieldInsnNode(
                        Opcodes.PUTFIELD,
                        classname,
                        potionID_intvar_name,
                        potionID_intvar_desc);
            ...
            } else if (mn.name.equals(method1_name.getVal(is_obfuscated))
                && mn.desc.equals(method1_desc.getVal(is_obfuscated))) {
                    // readPacketData
                    AbstractInsnNode target = null;
                    ...
                    while (instructions.hasNext()) {
                        ...
                        if (node instanceof MethodInsnNode) {
                            MethodInsnNode method = (MethodInsnNode) node;
                            if (method.owner.equals(method1_searchinstruction_owner.getVal(is_obfuscated))
                                && method.name.equals(method1_searchinstruction_function)
                                && method.desc.equals(method1_searchinstruction_desc)) {
                                target = node;
                                node = instructions.next();
                                if (node instanceof FieldInsnNode
                                    && ((FieldInsnNode) node).getOpcode() == Opcodes.PUTFIELD
                                    && ((FieldInsnNode) node).name.equals(potionid_bytevar_name.getVal(is_obfuscated))
                                    && ((FieldInsnNode) node).desc.equals(potionid_bytevar_origdesc)) {
                                    target2 = node;
                                    break;
                                }
                    ...
                    if (target != null && target2 != null) {
                        ...
                        new_if.add(
                            new MethodInsnNode(
                                Opcodes.INVOKEVIRTUAL,
                                method1_searchinstruction_owner.getVal(is_obfuscated),
                                method1_checkinstruction_function,
                                method1_checkinstruction_desc,
                                false));
                        ...
                        new_if.add(
                            new MethodInsnNode(
                                Opcodes.INVOKEVIRTUAL,
                                method1_searchinstruction_owner.getVal(is_obfuscated),
                                method1_replaceinstruction_function,
                                method1_replaceinstruction_desc,
                                false));
                        new_if.add(
                            new FieldInsnNode(Opcodes.PUTFIELD, classname, potionID_intvar_name, potionID_intvar_desc));
                        ...
                        new_if.add(
                            new MethodInsnNode(
                                Opcodes.INVOKEVIRTUAL,
                                method1_searchinstruction_owner.getVal(is_obfuscated),
                                method1_searchinstruction_function,
                                method1_searchinstruction_desc,
                                false));
                        new_if.add(
                            new FieldInsnNode(Opcodes.PUTFIELD, classname, potionID_intvar_name, potionID_intvar_desc));
                        ...
                        // MethodInsnNode new_readint = new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                        // method1_searchinstruction_owner.getVal(is_obfuscated), method1_replaceinstruction_function,
                        // method1_replaceinstruction_desc);
                        // FieldInsnNode new_potion_id_variable = new FieldInsnNode(Opcodes.PUTFIELD, classname,
                        // potionID_intvar_name, potionID_intvar_desc);
                        //
                    ...
                    && mn.desc.equals(method2_desc.getVal(is_obfuscated))) {
                            ...
                            if (node instanceof FieldInsnNode && ((FieldInsnNode) node).getOpcode() == Opcodes.GETFIELD
                                ...
                                if (node instanceof MethodInsnNode
                                    && ((MethodInsnNode) node).owner
                                        .equals(method2_searchinstruction_owner.getVal(is_obfuscated))
                                    && ((MethodInsnNode) node).name.equals(method2_searchinstruction_function)
                                    && ((MethodInsnNode) node).desc.equals(method2_searchinstruction_desc)) {
                                    target2 = node;
                                    break;
                                }
                        ...
                        if (target != null && target2 != null) {
                            // I don't think this advanced packet logic is even needed, as a server running AM2 would
                            // require AM2 on the client anyway.
                            // InsnList new_if = new InsnList();
                            // new_if.add(new VarInsnNode(Opcodes.ALOAD, 1));
                            // new_if.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                            // method2_searchinstruction_owner.getVal(is_obfuscated), method2_checkinstruction_function,
                            // method2_checkinstruction_desc, false));
                            // new_if.add(new IntInsnNode(Opcodes.BIPUSH, 7));
                            // LabelNode elseLabel = new LabelNode();
                            // new_if.add(new JumpInsnNode(Opcodes.IF_ICMPNE, elseLabel));
                            // new_if.add(new VarInsnNode(Opcodes.ALOAD, 1));
                            // new_if.add(new VarInsnNode(Opcodes.ALOAD, 0));
                            // new_if.add(new FieldInsnNode(Opcodes.GETFIELD, classname, potionID_intvar_name,
                            // potionID_intvar_desc));
                            // new_if.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                            // method2_searchinstruction_owner.getVal(is_obfuscated),
                            // method2_replaceinstruction_function, method2_replaceinstruction_desc, false));
                            // LabelNode endIfLabel = new LabelNode();
                            // new_if.add(new JumpInsnNode(Opcodes.GOTO, endIfLabel));
                            // new_if.add(elseLabel);
                            // new_if.add(new FrameNode(Opcodes.F_SAME, 0, null, 0, null));
                            ...
                            // new_if.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                            // method2_searchinstruction_owner.getVal(is_obfuscated),
                            // method2_searchinstruction_function, method2_searchinstruction_desc, false));
                            // new_if.add(endIfLabel);
                            // new_if.add(new FrameNode(Opcodes.F_SAME, 0, null, 0, null));
                            //
                            ...
                            FieldInsnNode new_potion_id_variable = new FieldInsnNode(
                                ...
                                potionID_intvar_name,
                                potionID_intvar_desc);
                            MethodInsnNode new_writeint = new MethodInsnNode(
                                Opcodes.INVOKEVIRTUAL,
                                method2_searchinstruction_owner.getVal(is_obfuscated),
                                method2_replaceinstruction_function,
                                method2_replaceinstruction_desc);
        ...
        newGetPotionIDMethod.instructions
            .add(new FieldInsnNode(Opcodes.GETFIELD, classname, potionID_intvar_name, potionID_intvar_desc));
        ...
        if (!is_obfuscated) {
            try {
                ...
                outDir.mkdirs();
                DataOutputStream dout = new DataOutputStream(
                    new FileOutputStream(new File(outDir, "SD1PacketEntityEffect_post.class")));
                dout.write(cw.toByteArray());
                dout.flush();
                dout.close();
            } catch (Exception e) {
    ...
    private byte[] alterNetHandlerPlayClient(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: bjb/a (Lin;)V net/minecraft/client/network/NetHandlerPlayClient/func_147260_a
    ...
    private byte[] alterS1EPacketRemoveEntityEffect(byte[] bytes, boolean is_obfuscated) {
        ...
        // MCP mapping: MD: hr/a (Let;)V net/minecraft/network/play/server/S1EPacketRemoveEntityEffect/func_148837_a
        // (Lnet/minecraft/network/PacketBuffer;)V
        ...
        for (MethodNode mn : cn.methods) {
            ...
            if (mn.name.equals(method1_name.getVal(is_obfuscated))
                ...
                && mn.desc.equals(method2_desc.getVal(is_obfuscated))) {
                    ...
                    if (target != null) {
                        // FieldInsnNode new_potion_id_variable = new FieldInsnNode(Opcodes.GETFIELD, classname,
                        // potionID_intvar_name, potionID_intvar_desc);
                        MethodInsnNode new_writeint = new MethodInsnNode(
                            Opcodes.INVOKEVIRTUAL,
                            method2_searchinstruction_owner.getVal(is_obfuscated),
