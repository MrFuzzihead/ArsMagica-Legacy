...
public class BlocksCommonProxy {
    ...
    public BlocksCommonProxy() {
        ...
        if (blockTab == null) blockTab = new AMCreativeTab("Ars Magica Blocks");

        if (arsMagicaBlocksList == null) arsMagicaBlocksList = new ArrayList<Block>();
    }
    ...
    public void registerKeystonePortal(int x, int y, int z, int dimension) {
        ...
        if (!dimensionList.contains(location)) dimensionList.add(location);
    }
    ...
    public AMVector3 getNextKeystonePortalLocation(World world, int x, int y, int z, boolean multidimensional,
        long key) {
    ...
    public void InstantiateBlocks() {
        ...
        blockMageTorch = new BlockMageLight().setUnlocalizedNameAndID("arsmagica2:magetorch")
            .setCreativeTab(blockTab);
        ...
        essenceConduit = new BlockEssenceConduit().setUnlocalizedNameAndID("arsmagica2:essenceconduit")
            .setCreativeTab(blockTab);
        caster = (new BlockCaster()).setUnlocalizedNameAndID("arsmagica2:blockcaster")
            .setCreativeTab(blockTab);
        casterRune = (BlockCasterRune) (new BlockCasterRune()).setUnlocalizedNameAndID("arsmagica2:casterRune")
            .setCreativeTab(blockTab);

        obelisk = new BlockEssenceGenerator(BlockEssenceGenerator.NEXUS_STANDARD)
            .setUnlocalizedNameAndID("arsmagica2:obelisk")
            .setCreativeTab(blockTab);
        calefactor = new BlockCalefactor().setUnlocalizedNameAndID("arsmagica2:calefactor")
            .setCreativeTab(blockTab);
        keystoneRecepticle = (BlockKeystoneReceptacle) new BlockKeystoneReceptacle()
            .setUnlocalizedNameAndID("arsmagica2:blockkeystonerecepticle")
            .setCreativeTab(blockTab);
        astralBarrier = new BlockAstralBarrier().setUnlocalizedNameAndID("arsmagica2:blockastralbarrier")
            .setCreativeTab(blockTab);
        blackAurem = new BlockEssenceGenerator(BlockEssenceGenerator.NEXUS_DARK)
            .setUnlocalizedNameAndID("arsmagica2:blackaurem")
            .setCreativeTab(blockTab);
        spatialVortex = new BlockSpatialVortex().setUnlocalizedNameAndID("arsmagica2:spatialVortex")
            .setCreativeTab(blockTab);
        seerStone = new BlockSeerStone().setUnlocalizedNameAndID("arsmagica2:blockseerstone")
            .setCreativeTab(blockTab);
        celestialPrism = new BlockEssenceGenerator(BlockEssenceGenerator.NEXUS_LIGHT)
            .setUnlocalizedNameAndID("arsmagica2:celestialprism")
            .setCreativeTab(blockTab);
        ...
        desertNova = (BlockDesertNova) new BlockDesertNova().setUnlocalizedNameAndID("arsmagica2:desert_nova")
            .setCreativeTab(blockTab);
        keystoneChest = (BlockKeystoneChest) new BlockKeystoneChest()
            .setUnlocalizedNameAndID("arsmagica2:keystonechest")
            .setCreativeTab(blockTab);
        blockLectern = new BlockLectern().setUnlocalizedNameAndID("arsmagica2:lectern")
            .setCreativeTab(blockTab);
        blockArcaneReconstructor = new BlockArcaneReconstructor()
            .setUnlocalizedNameAndID("arsmagica2:arcanereconstructor")
            .setCreativeTab(blockTab);
        manaBattery = new BlockManaBattery().setUnlocalizedNameAndID("arsmagica2:mana_battery")
            .setCreativeTab(blockTab);
        magicWall = new BlockMagicWall().setUnlocalizedNameAndID("arsmagica2:magicWall")
            .setCreativeTab(blockTab);
        occulus = new BlockOcculus().setUnlocalizedNameAndID("arsmagica2:occulus")
            .setCreativeTab(blockTab);
        craftingAltar = (BlockCraftingAltar) new BlockCraftingAltar()
            .setUnlocalizedNameAndID("arsmagica2:altarOfCreation")
            .setCreativeTab(blockTab);
        spellRune = (BlockGroundRuneSpell) new BlockGroundRuneSpell().setUnlocalizedNameAndID("arsmagica2:spellRune");
        particleEmitter = (BlockParticleEmitter) new BlockParticleEmitter()
            .setUnlocalizedNameAndID("arsmagica2:particleEmitter")
            .setCreativeTab(blockTab);
        vinteumTorch = (VinteumTorch) new VinteumTorch().setBlockName("arsmagica2:vinteumTorch")
            .setCreativeTab(blockTab);
        inscriptionTable = (BlockInscriptionTable) new BlockInscriptionTable()
            .setUnlocalizedNameAndID("arsmagica2:inscriptionTable")
            .setCreativeTab(blockTab);
        invisibleUtility = (BlockInvisibleUtility) new BlockInvisibleUtility()
            .setUnlocalizedNameAndID("arsmagica2:invisibleUtility");
        aum = (AMFlower) new AMFlower().setUnlocalizedNameAndID("arsmagica2:aum")
            .setCreativeTab(blockTab);
        ...
        tarmaRoot = (BlockTarmaRoot) new BlockTarmaRoot().setUnlocalizedNameAndID("arsmagica2:tarmaroot")
            .setCreativeTab(blockTab);
        effervescentSnowdrop = (BlockEffervescentSnowdrop) new BlockEffervescentSnowdrop()
            .setUnlocalizedNameAndID("arsmagica2:effervescentSnowdrop")
            .setCreativeTab(blockTab);
        sanguineAmaryllis = (BlockSanguineAmaryllis) new BlockSanguineAmaryllis()
            .setUnlocalizedNameAndID("arsmagica2:sanguineAmaryllis")
            .setCreativeTab(blockTab);
        infusedStem = (BlockInfusedStem) new BlockInfusedStem().setUnlocalizedNameAndID("arsmagica2:infusedStem")
            .setCreativeTab(blockTab);
        witchwoodLog = (BlockWitchwoodLog) new BlockWitchwoodLog().setBlockName("arsmagica2:witchwoodlog")
            .setCreativeTab(blockTab);
        witchwoodLogDrained = (BlockWitchwoodLogDrained) new BlockWitchwoodLogDrained()
            .setBlockName("arsmagica2:drainedwitchwoodlog")
            .setCreativeTab(blockTab);
        ...
        witchwoodStairs = (WitchwoodStairs) new WitchwoodStairs(witchwoodPlanks, 0)
            .setBlockName("arsmagica2:stairsWitchwood")
            .setCreativeTab(blockTab);
        witchwoodSapling = (WitchwoodSapling) new WitchwoodSapling().setBlockName("arsmagica2:saplingWitchwood")
            .setCreativeTab(blockTab);
        magiciansWorkbench = (BlockMagiciansWorkbench) new BlockMagiciansWorkbench()
            .setBlockName("arsmagica2:magiciansWorkbench")
            .setCreativeTab(blockTab);
        everstone = (BlockEverstone) new BlockEverstone().setBlockName("arsmagica2:everstone")
            .setCreativeTab(blockTab);
        keystoneDoor = (BlockKeystoneDoor) new BlockKeystoneDoor().setBlockName("arsmagica2:keystoneDoor");
        keystoneTrapDoor = (BlockKeystoneTrapdoor) new BlockKeystoneTrapdoor()
            .setBlockName("arsmagica2:keystoneTrapdoor");
        slipstreamGenerator = (BlockSlipstreamGenerator) new BlockSlipstreamGenerator()
            .setBlockName("arsmagica2:slipstreamGenerator")
            .setCreativeTab(blockTab);
        ...
        inertSpawner = (BlockInertSpawner) new BlockInertSpawner().setBlockName("arsmagica2:inertSpawner")
            .setCreativeTab(blockTab);
        candle = (BlockCandle) new BlockCandle().setBlockName("arsmagica2:candle")
            .setCreativeTab(blockTab);
        ...
        flickerLure = (BlockFlickerLure) new BlockFlickerLure().setBlockName("arsmagica2:flicker_lure")
            .setCreativeTab(blockTab);
        arcaneDeconstructor = (BlockArcaneDeconstructor) new BlockArcaneDeconstructor()
            .setBlockName("arsmagica2:arcane_deconstructor")
            .setCreativeTab(blockTab);
        otherworldAura = (BlockOtherworldAura) new BlockOtherworldAura().setBlockName("arsmagica2:otherworld_aura")
            .setCreativeTab(blockTab);
        spellSealedDoor = (BlockSpellSealedDoor) new BlockSpellSealedDoor()
            .setBlockName("arsmagica2:spell_sealed_door");
        entropicEnervator = (BlockEntropicEnervator) new BlockEntropicEnervator()
            .setBlockName("arsmagica2:entropic_enervator")
            .setCreativeTab(blockTab);
        spellReplicator = (BlockSpellReplicator) new BlockSpellReplicator().setBlockName("arsmagica2:spellReplicator")
            .setCreativeTab(blockTab);
        cosmicRock = new AMCosmicRock(Material.rock).setUnlocalizedNameAndID("arsmagica2:cosmicRock")
            .setHardness(50.0F)
            .setCreativeTab(blockTab);
    ...
    public void InitRecipes() {
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(essenceRefiner, 1),
                new Object[] { "PDP", "OAO", "PPP", 'P', "plankWood", 'O', Blocks.obsidian, 'A', "arcaneAsh", 'D',
                    "gemDiamond" }));

        // essence conduit
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(essenceConduit, 1),
                new Object[] { " C ", " S ", "SSS", 'S', "stone", 'C', "gemChimerite" }));

        // caster
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(caster, 1),
                new Object[] { "SRS", "AVA", "SFS", 'A', "arcaneAsh", 'S', "stone", 'F',
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SOULFRAGMENT), 'R', "dustRedstone", 'V',
                    "dustVinteum" }));

        // caster rune
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(casterRune, 1),
                new Object[] { "RRR", "APA", "SVS", 'A', "arcaneAsh", 'S', "stone", 'V', "dustVinteum", 'R',
                    ItemsCommonProxy.rune, 'P',
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SOULFRAGMENT) }));

        // summoner
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(summoner, 1),
                new Object[] { "GVG", "GOG", "OOO", 'G', "ingotGold", 'O', Blocks.obsidian, 'V', "dustVinteum" }));

        // Calefactor
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(calefactor, 1),
                new Object[] { "L L", "SRS", "SVS", 'L', new ItemStack(Items.dye, 1, 4), // lapis
                    'S', "stone", 'R', "dustRedstone", 'V', "dustVinteum" }));

        // keystone recepticle
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(keystoneRecepticle, 1),
                new Object[] { "SVS", "EPE", "SVS", 'P', new ItemStack(ItemsCommonProxy.essence, 1, 9), 'S',
                    Blocks.stonebrick, 'E', Items.ender_eye, 'V', "dustVinteum" }));

        // astral barrier
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(astralBarrier, 1),
                new Object[] { "WVW", "E E", "WVW",
                    // Character.valueOf('P'), new ItemStack(ItemsCommonProxy.essence, 1,
                    // ItemsCommonProxy.essence.META_ENDER),
                    'W', Blocks.cobblestone_wall, 'E', Items.ender_eye, 'V', "dustVinteum" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(seerStone, 1),
                new Object[] { " E ", "SRS", 'S', "stone", // stone wall
                    'E', Items.ender_eye, 'R', "dustRedstone" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(keystoneChest),
                new Object[] { "WRW", "WVW", "WRW", 'W', "plankWood", 'R', new ItemStack(ItemsCommonProxy.rune, 1, 0),
                    'V', "dustVinteum" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(blockLectern),
                new Object[] { "SSS", " P ", 'S', "slabWood", 'P', "plankWood" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(occulus),
                new Object[] { "SPS", " S ", "CVC", 'S', Blocks.stonebrick, 'C', Items.coal, 'P', "blockGlassColorless",
                    'V', "gemBlueTopaz" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(blockArcaneReconstructor),
                new Object[] { "SWS", "VDV", "SOS", 'S', "stone", 'V', "dustVinteum", 'D', "gemDiamond", 'W',
                    BlocksCommonProxy.magicWall, 'O', Blocks.obsidian }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(arcaneDeconstructor),
                new Object[] { "IGR", "WDW", "CWC", 'I', ItemsCommonProxy.itemFocus, 'G', "blockGlassColorless", 'R',
                    new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_PURE), 'W', witchwoodPlanks, 'D',
                    ItemsCommonProxy.deficitCrystal, 'C',
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_PYROGENICSEDIMENT), }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(flickerLure),
                new Object[] { "CIV", "SSS", 'C', "gemChimerite", 'I', "ingotIron", 'V', "dustVinteum", 'S',
                    Blocks.stonebrick }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(manaBattery),
                new Object[] { "IVI", "VAV", "IVI", 'I', "gemChimerite", 'V', "dustVinteum", 'A', "arcaneAsh" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(magicWall, 16, 0),
                new Object[] { "VSV", 'V', "dustVinteum", 'S', "stone" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(craftingAltar),
                new Object[] { "V", "S", 'V', "dustVinteum", 'S', "stone" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(vinteumTorch, 4),
                new Object[] { "V", "S", 'V', "dustVinteum", 'S', "stickWood" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                inscriptionTable,
                new Object[] { "TPF", "SSS", "W W", 'T', Blocks.torch, 'P', ItemsCommonProxy.spellParchment, 'F',
                    Items.feather, 'S', "slabWood", 'W', "plankWood" }));

        GameRegistry
            .addRecipe(new ItemStack(Blocks.stonebrick, 1, 3), new Object[] { "SS", "SS", 'S', Blocks.stonebrick });

        // Inlays

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(redstoneInlay, 4, 0),
                new Object[] { "RRR", "RVR", "RRR", 'R', "dustRedstone", 'V', "dustVinteum" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ironInlay, 4, 0),
                new Object[] { "III", "IVI", "III", 'I', "ingotIron", 'V', "arcaneAsh" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(goldInlay, 4, 0),
                new Object[] { "GGG", "GVG", "GGG", 'G', "ingotGold", 'V',
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_PURIFIEDVINTEUM) }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(particleEmitter),
                new Object[] { " C ", "CIC", " C ", 'I', illusionBlock, 'C', "gemChimerite" }));

        GameRegistry.addRecipe(new ItemStack(witchwoodPlanks, 4), new Object[] { "W", 'W', witchwoodLog });

        RecipeUtilities.addShapedRecipeFirst(
            recipes,
            new ItemStack(witchwoodSingleSlab, 6),
            new Object[] { "WWW", 'W', witchwoodPlanks });

        RecipeUtilities.addShapedRecipeFirst(
            recipes,
            new ItemStack(witchwoodStairs, 4),
            new Object[] { "  W", " WW", "WWW", 'W', witchwoodPlanks });

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(everstone),
                new Object[] { " B ", "CSC", " B ", 'C', "gemChimerite", 'S', "stone", 'B', "gemBlueTopaz" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(magiciansWorkbench),
                new Object[] { "COC", "SWS", "LHL", 'C', "craftingTableWood", 'O', new ItemStack(Blocks.carpet), 'W',
                    "logWood", 'S', "slabWood", 'L', "plankWood", 'H', "chestWood" }));

        GameRegistry.addRecipe(
            new ItemStack(slipstreamGenerator),
            new Object[] { "WWW", "FAF", "WWW", 'W', witchwoodLog, 'F', Items.feather, 'A',
                new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_AIR) });

        // Flicker Habitat
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(elementalAttuner),
                new Object[] { "IDI", "DBD", "IDI", 'I', "ingotIron", 'D', "dustVinteum", 'B',
                    new ItemStack(AMOres, 1, BlockAMOre.META_CHIMERITE_BLOCK) }));

        // Import Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_IN),
                new Object[] { " G ", "GDG", " G ", 'G', "gemBlueTopaz", 'D', "dyeYellow" // Yellow Dye
                }));

        // Export Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_OUT),
                new Object[] { " G ", "GDG", " G ", 'G', "gemBlueTopaz", 'D', "dyeBlue" // Lapis
                }));

        // Final Export Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_FINAL_DEST),
                new Object[] { " G ", "GDG", " G ", 'G', "gemBlueTopaz", 'D', "dyeGray" // Lapis
                }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "GDG", "DED", "GDG", 'G', "gemBlueTopaz", 'D', "dyeGreen", // Cactus Green
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "GDG", "DED", "GDG", 'G', "gemBlueTopaz", 'D', "dyePurple", // Purple Dye
                    'E', new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_OUT) }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "GDG", "DED", "GDG", 'G', "gemBlueTopaz", 'D', "dyeLightBlue", // Light Blue Dye
                    'E', new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_OUT) }));

        // Regulate Bidirectional
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_REGULATE_MULTI),
                new Object[] { "DSD", "GEG", "DSD", 'S', "gemSunstone", 'G', "gemBlueTopaz", 'D', "dyeOrange", 'E',
                    new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_REGULATE_EXPORT) }));

        // Set Export Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_SET_IMPORT),
                new Object[] { "DSD", "GEG", "DSD", 'S', "gemSunstone", 'G', "gemBlueTopaz", 'D', "dyeRed", 'E',
                    new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_SET_EXPORT) }));

        // Spell Export Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_SPELL_EXPORT),
                new Object[] { "C C", "RPI", "C C", 'P',
                    new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_PURE), 'I',
                    new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_SET_IMPORT), 'C', "dyeCyan", 'R',
                    new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_REGULATE_MULTI) }));

        // Gem Conversions
        createTier2GemConverstionRecipies(
            new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_LIKE_EXPORT),
            "dyeGreen");
        createTier2GemConverstionRecipies(
            new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_REGULATE_EXPORT),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(obelisk),
                new Object[] { "VSV", "SCS", "VSV", 'V', "dustVinteum", 'S', "stone", 'C',
                    new ItemStack(Blocks.stonebrick, 1, 3) }));

        // Armor Infuser
        GameRegistry.addRecipe(
            new ItemStack(armorInfuser),
            new Object[] { "ACA", "OPO", "OOO", 'A', BlocksCommonProxy.craftingAltar, 'C',
                new ItemStack(Blocks.carpet, 1, Short.MAX_VALUE), 'O', Blocks.obsidian, 'P', Blocks.enchanting_table });

        // Spell Replicator
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(spellReplicator),
                new Object[] { "VDV", "WFW", "VDV", 'W', new ItemStack(BlocksCommonProxy.magicWall), 'V', "dustVinteum",
                    'D', new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_COSMICDUST), 'F',
                    new ItemStack(ItemsCommonProxy.flickerJar, 1, Affinity.ARCANE.ordinal()) }));

        // Entropic Enervator
        GameRegistry.addRecipe(
            new ItemStack(entropicEnervator),
            new Object[] { "GCG", "ORO", "OOO", 'G', BlocksCommonProxy.goldInlay, 'C', ItemsCommonProxy.deficitCrystal,
                'O', Blocks.obsidian, 'R', Items.redstone });

        // storage blocks
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, BlockAMOre.META_MOONSTONE_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_MOONSTONE));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, BlockAMOre.META_VINTEUM_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_VINTEUMDUST));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, BlockAMOre.META_BLUE_TOPAZ_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_BLUETOPAZ));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, BlockAMOre.META_SUNSTONE_BLOCK),
        ...
        GameRegistry.addSmelting(
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_ARCANECOMPOUND),
            new ItemStack(ItemsCommonProxy.itemOre, 2, ItemOre.META_ARCANEASH),
            0);

        addMetaSmeltingRecipe(
            AMOres,
            BlockAMOre.META_VINTEUM_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_VINTEUMDUST));

        addMetaSmeltingRecipe(
            AMOres,
            BlockAMOre.META_SUNSTONE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_SUNSTONE));
        addMetaSmeltingRecipe(
            AMOres,
            BlockAMOre.META_BLUE_TOPAZ_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_BLUETOPAZ));
        addMetaSmeltingRecipe(
            AMOres,
            BlockAMOre.META_CHIMERITE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_CHIMERITE));
        addMetaSmeltingRecipe(
            AMOres,
            BlockAMOre.META_MOONSTONE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemOre.META_MOONSTONE));
        ...
        GameRegistry.addRecipe(
            new ItemStack(illusionBlock, illusionBlock.GetCraftingQuantity(), 0),
            illusionBlock.GetRecipeComponents(false));
        GameRegistry.addRecipe(
            new ItemStack(illusionBlock, illusionBlock.GetCraftingQuantity(), 1),
            illusionBlock.GetRecipeComponents(true));
    }
    ...
    private void createStorageBlockRecipe(ItemStack storageBlock, ItemStack storageItem) {
        GameRegistry.addRecipe(
            ...
            new Object[] { "III", "III", "III", 'I',
                new ItemStack(storageItem.getItem(), 1, storageItem.getItemDamage()) });

        GameRegistry
            .addShapelessRecipe(new ItemStack(storageItem.getItem(), 9, storageItem.getItemDamage()), storageBlock);
    }
    ...
    private void createTier2GemConverstionRecipies(ItemStack stack, String dyeCode) {
        if (stack.getItemDamage() != BlockCrystalMarker.META_LIKE_EXPORT) {
            GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                    stack,
                    new Object[] { new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_LIKE_EXPORT), dyeCode }));
        }
        ...
        if (stack.getItemDamage() != BlockCrystalMarker.META_REGULATE_EXPORT) {
            GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                    stack,
                    new Object[] { new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_REGULATE_EXPORT),
                        dyeCode }));
        }
        ...
        if (stack.getItemDamage() != BlockCrystalMarker.META_SET_EXPORT) {
            GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                    stack,
                    new Object[] { new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_SET_EXPORT), dyeCode }));
        }
    }
    ...
    public void RegisterBlocks() {
        ...
        /*
         * Item.itemsList[BlocksCommonProxy.witchwoodSingleSlab.blockID] = new
         * ItemSlab(BlocksCommonProxy.witchwoodSingleSlab.blockID - 256, BlocksCommonProxy.witchwoodSingleSlab,
         * BlocksCommonProxy.witchwoodDoubleSlab, false);
         * Item.itemsList[BlocksCommonProxy.witchwoodDoubleSlab.blockID] = new
         * ItemSlab(BlocksCommonProxy.witchwoodDoubleSlab.blockID - 256, BlocksCommonProxy.witchwoodSingleSlab,
         * BlocksCommonProxy.witchwoodDoubleSlab, true);
         * Item.itemsList[BlocksCommonProxy.illusionBlock.blockID] = (new
         * ItemMultiTextureTile(BlocksCommonProxy.illusionBlock.blockID - 256, BlocksCommonProxy.illusionBlock,
         * IllusionBlock.illusion_block_types)).setUnlocalizedName("arsmagica2:illusionBlock");
         * Item.itemsList[BlocksCommonProxy.crystalMarker.blockID] = (new
         * ItemMultiTextureTile(BlocksCommonProxy.crystalMarker.blockID - 256, BlocksCommonProxy.crystalMarker,
         * BlockCrystalMarker.crystalMarkerTypes)).setUnlocalizedName("arsmagica2:crystalMarker");
         */
        registerMultiTextureBlock(
            witchwoodSingleSlab,
            "witchwoodSingleSlab",
            new ItemSlab(witchwoodSingleSlab, witchwoodSingleSlab, witchwoodDoubleSlab, false));
        registerMultiTextureBlock(
            witchwoodDoubleSlab,
            "witchwoodDoubleSlab",
            new ItemSlab(witchwoodDoubleSlab, witchwoodSingleSlab, witchwoodDoubleSlab, false));
        registerMultiTextureBlock(
            illusionBlock,
            "illusionBlock",
            new ItemMultiTexture(illusionBlock, illusionBlock, IllusionBlock.illusion_block_types)
                .setUnlocalizedName("arsmagica2:illusionBlock"));
        registerMultiTextureBlock(
            crystalMarker,
            "crystalMarker",
            new ItemMultiTexture(crystalMarker, crystalMarker, BlockCrystalMarker.crystalMarkerTypes)
                .setUnlocalizedName("arsmagica2:crystalMarker"));
    ...
    private <T extends ItemBlock> void registerMultiTextureBlock(Block block, String unlocalizedName, T item) {
        ...
        try {
            ...
            Method registerBlock = ReflectionHelper
                .findMethod(GameData.class, data, new String[] { "registerBlock" }, Block.class, String.class);
            Method registerItem = ReflectionHelper
                .findMethod(GameData.class, data, new String[] { "registerItem" }, Item.class, String.class);
