...
public class BlocksClientProxy extends BlocksCommonProxy {
    ...
    public void registerRenderInformation() {
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityKeystoneRecepticle.class, new KeystoneReceptacleRenderer());
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityArcaneReconstructor.class, new ArcaneReconstructorRenderer());
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityMagiciansWorkbench.class, new MagiciansWorkbenchRenderer());
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityCrystalMarkerSpellExport.class, new CrystalMarkerRenderer());
