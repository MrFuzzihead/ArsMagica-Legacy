...
public class AffinityData implements IExtendedEntityProperties, IAffinityData {
    ...
    public void handleExtendedPropertySync() {
        ...
        if (!entity.worldObj.isRemote && this.hasUpdate()) {
            ...
            AMNetHandler.INSTANCE.sendPacketToAllClientsNear(
                ...
                entity.posZ,
                32,
                AMPacketIDs.SYNC_AFFINITY_DATA,
                data);
        }
    }
    ...
    private void updateHighestAffinities() {
        ...
        while (it.hasNext()) {
            ...
            if (Math.floor(f * 100.0f) / 100.0f == 0) it.remove();
        }
        ...
        for (int i = 0; i < highestAffinities.length; ++i) {
            ...
            else highestAffinities[highestAffinities.length - 1 - i] = null;
        }
    }
    ...
    public List getColoredAffinityEffects(Affinity aff) {
        ...
        switch (aff) {
            case AIR:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.agile")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.lightasafeather")).toString());
                break;
            case ARCANE:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.4f,
                        StatCollector.translateToLocal("am2.affinity.clearcaster")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.onewithmagic")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.magicweakness")).toString());
                break;
            case EARTH:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.1f,
                        StatCollector.translateToLocal("am2.affinity.stoneskin")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.solidbones")).toString());
                break;
            case ENDER:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.waterweakness")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 1.00f,
                        StatCollector.translateToLocal("am2.affinity.sunlightweakness")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.poisonresistance")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.75f,
                        StatCollector.translateToLocal("am2.affinity.darkvision")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 0.75,
                        StatCollector.translateToLocal("am2.affinity.phasing")).toString());
                break;
            case FIRE:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.fireresistance")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.firepunch")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.waterweakness")).toString());
            ...
            case ICE:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.waterfreeze")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 1.0f,
                        StatCollector.translateToLocal("am2.affinity.lavafreeze")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.1f,
                        StatCollector.translateToLocal("am2.affinity.coldblooded")).toString());
                break;
            case LIFE:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.1f,
                        StatCollector.translateToLocal("am2.affinity.fasthealing")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.6f,
                        StatCollector.translateToLocal("am2.affinity.pacifist")).toString());
                break;
            case WATER:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.swiftswim")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.4f,
                        StatCollector.translateToLocal("am2.affinity.expandedlungs")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.fluidity")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 1f,
                        StatCollector.translateToLocal("am2.affinity.antiendermen")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.fireweakness")).toString());
                break;
            case NATURE:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.harvester")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.thorns")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 1f,
                        StatCollector.translateToLocal("am2.affinity.photosynthesis")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.1f,
                        StatCollector.translateToLocal("am2.affinity.rooted")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) >= 1f,
                        StatCollector.translateToLocal("am2.affinity.leaflike")).toString());
                break;
            case LIGHTNING:
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.65f,
                        StatCollector.translateToLocal("am2.affinity.reflexes")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.25f,
                        StatCollector.translateToLocal("am2.affinity.shortcircuit")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.75f,
                        StatCollector.translateToLocal("am2.affinity.thunderpunch")).toString());
                list.add(
                    new AffinityEffectDescriptor(
                        getAffinityDepth(aff) > 0.5f,
                        StatCollector.translateToLocal("am2.affinity.fulmination")).toString());
                break;
            case NONE:
                break;
            default:
                ...
                if (this.lastGroundPosition != null) {
                    if (positionIsValid(lastGroundPosition)) {
                        ...
                        this.entity.setPosition(
                            ...
                            this.lastGroundPosition.y + 1,
                            this.lastGroundPosition.z);
                        ExtendedProperties.For((EntityLivingBase) this.entity)
                            .setFallProtection(20000);
                        ...
                        ((EntityPlayer) this.entity)
                            .addChatMessage(new ChatComponentText("am2.affinity.enderTPFailed"));
                    }
                } else {
    ...
    private boolean positionIsValid(AMVector3 pos) {
        return this.entity.worldObj
            .isAirBlock((int) Math.floor(pos.x), (int) Math.floor(pos.y + 1), (int) Math.floor(pos.z))
            && this.entity.worldObj
                .isAirBlock((int) Math.floor(pos.x), (int) Math.floor(pos.y + 2), (int) Math.floor(pos.z));
    }
