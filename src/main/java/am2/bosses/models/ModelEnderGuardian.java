...
public class ModelEnderGuardian extends ModelBase {
    ...
    private void flapWings(EntityEnderGuardian entity, float f, float f1, float f2, float f3, float f4, float f5) {
        float angle = MathHelper
            .sin((entity.getWingFlapTime() + f2 - entity.ticksExisted + f5) * entity.getWingFlapSpeed()) / 3
            * 2;
        ...
        GL11.glTranslatef(
            0,
            MathHelper.sin((entity.getWingFlapTime() + f2 - entity.ticksExisted + f5) * entity.getWingFlapSpeed()) / 8,
            0);
    }
